...
public class AutoCompleteComboBoxListener implements EventHandler<KeyEvent> {
    ...
    private void selectClosestResultBasedOnTextFieldValue(boolean affect, boolean inFocus) {
        ...
        if (!inFocus && comboBox.getEditor().getText() != null && comboBox.getEditor().getText().trim().length() > 0) {
           ...
           // KeyEvent ke = javafx.scene.input.KeyEvent.impl_keyEvent(comboBox, KeyCode.ENTER.toString(), KeyCode.ENTER.getName(), KeyCode.ENTER.impl_getCode(), false, false, false, false, KeyEvent.KEY_RELEASED);
            //KeyEvent ke = new KeyEvent((java.lang.Object)KeyCode.ENTER.toString(), comboBox, KeyEvent.KEY_RELEASED);
//KeyEvent ke = new javafx.scene.input.KeyEvent(
//        KeyCode.ENTER.toString(), comboBox, 
//        KeyEvent.KEY_RELEASED, null, null, KeyCode.DOWN, false, false, false, false);
