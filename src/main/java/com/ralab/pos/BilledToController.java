...
import static com.ralab.pos.BillingController.bt_stage;
import static com.ralab.pos.BillingController.setBTText;
import java.net.URL;
 ...
 * @author lab149
 */
public class BilledToController implements Initializable {
    ...
    private void handleChooseCustomerButtonAction(ActionEvent event) {
        ...
        bt_stage.close();
        BillingController.bt_stage_on = false;
