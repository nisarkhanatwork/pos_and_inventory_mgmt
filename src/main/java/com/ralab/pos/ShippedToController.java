...
import static com.ralab.pos.BillingController.setSTText;
import static com.ralab.pos.BillingController.st_stage;
import java.net.URL;
 ...
 * @author lab149
 */
public class ShippedToController implements Initializable {
    ...
    private void handleChooseCustomerButtonAction(ActionEvent event) {
        ...
        st_stage.close();
        BillingController.st_stage_on = false;
